...
def main(args):
    ...
    if args.Mode == 'spec':
        simulation_fast(target_model=target_model, draft_model=draft_model, prompts=prompts[1:4],tokenizer=tokenizer, T=args.T, top_p=args.P,
        ...
        simulation_baseline(target_model=target_model, draft_model=None, prompts=prompts[1:4],tokenizer=tokenizer, T=args.T, top_p=args.P,
